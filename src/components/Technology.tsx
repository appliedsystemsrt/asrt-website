...
const technologies: TechNode[] = [
  ...
  {
    id: "gpu",
    label: "GPU Engineering",
    shortLabel: "GPU",
    description: "Building and optimizing GPU-accelerated systems for high-performance AI training, real-time inference, and compute-heavy workloads.",
    applications: ["GPU Cluster Design", "CUDA Optimization", "AI Training Infrastructure", "Inference Acceleration"],
    related: ["AI", "ML", "HPC"],
  ...
  },
  {
    ...
    shortLabel: "AI Infra",
    description: "Architecting the cloud, data, and MLOps infrastructure that powers scalable enterprise AI systems end to end.",
    applications: ["MLOps Pipelines", "Model Serving", "Data Platforms", "Kubernetes & Cloud"],
    related: ["AI", "ML", "Cloud"],
    category: "Infrastructure",
  },
  {
